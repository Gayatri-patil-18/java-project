													...
													<h3 class="inner-tittle two">Police Station Information</h3>
														  <div class="graph">
															<div class="tables">
																...
																<table class="table table-bordered"> <thead> <tr> <th>Location Name</th> <th>Address</th> <th>Reason</th> <th>Latitude</th> <th>Longitude</th> <th>Level</th> <th>City</th> <th>Action</th> </tr> </thead> <tbody>
																<%
																 try
																{
																	 Connection con = ConnectionDB.connect(); 
																	 PreparedStatement ps1 = con.prepareStatement("select * from blackspot");
																	 
																	 ResultSet rs = ps1.executeQuery(); 
																	 while(rs.next())
																	{
																%>  
																 	<tbody> <tr> <td><%=rs.getString("Lname") %></td> <td><%=rs.getString("Add") %></td> <td><%=rs.getString("Reason") %></td> <td><%=rs.getString("Latitude") %></td> <td><%=rs.getString("Longitude") %></td>  <td><%=rs.getInt("Level") %></td> <td><%=rs.getString("City") %></td>  <td><a href="deleteBlackSpot.jsp?bid=<%=rs.getInt("bid") %>" >--Delete--</a></tr> 
																 <%
																	}  
                                  ...
                                  <div class="menu">
									<ul id="menu" >
										 <li id="menu-academico" ><a href="addBlackSpots.html"><i class="fa fa-home"></i> <span> Add Black Spot</span> <span class="fa fa-angle-right" style="float: right"></span></a>
 										  <li id="menu-academico" ><a href="viewBlackSpotD.jsp"><i class="fa fa-columns"></i> <span> View Black Spots</span> <span class="fa fa-angle-right" style="float: right"></span></a>
