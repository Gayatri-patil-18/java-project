							...
							<div class="outter-wp">
								  ...
								  <!--//sub-heard-part-->
									<div class="graph-visual tables-main">
													...
													<h3 class="inner-tittle two">Crime Black Spots</h3>
														  <div class="graph">
															<div class="tables">
																 ...
																 try
																{
																	 ...
																	 PreparedStatement ps1 = con.prepareStatement("select * from blackspot where Reason='Crime' "); 
														...
														<h3 class="inner-tittle two">Accident Black Spots</h3>
														  <div class="graph">
															<div class="tables">
																...
																{
																	 Connection con = ConnectionDB.connect(); 
																	 PreparedStatement ps1 = con.prepareStatement("select * from blackspot where Reason='Accidents' "); 
